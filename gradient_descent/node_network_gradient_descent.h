...
void node_layer_derivatives(struct Node_Network *node_network, struct Node_Network_Data_Partition *node_network_data_partition, struct Gradient_Descent_Derivatives *gradient_descent_derivatives, size_t node_layer_index, float* target_output)
{
