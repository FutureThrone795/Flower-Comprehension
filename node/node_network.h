...
void initialize_node_network(struct Node_Network *node_network, float* input, uint8_t node_layer_count, size_t first_node_layer_input_count, size_t* node_layer_output_counts)
{
