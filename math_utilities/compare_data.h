...
float calculate_data_difference_squared(float *data_1, float *data_2, unsigned long long data_size)
{
...
float calculate_aggregate_batch_data_difference_squared(struct Node_Network *node_network, struct Node_Network_Data_Partition *node_network_data_partition, float **batch_data, unsigned long long batch_size, unsigned long long individual_data_size)
{
